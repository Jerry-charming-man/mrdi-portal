/**
 * MDM API fetch client for orval
...
export const mdmApiClient = async <T>(
  url: string,
  ...
  // orval v8 generated code destructures { data, status, ... } from result.
  // Return a "data"-shaped object so consumers can use it.
