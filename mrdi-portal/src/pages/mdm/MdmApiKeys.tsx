export default function MdmApiKeys() {
  return (
    <div className="px-8 py-6 space-y-5">
      <div>
        <h1 className="text-[22px] font-semibold tracking-tight">API Keys</h1>
        <p className="text-[13px] text-ink-3 mt-1">已签发密钥 · 访问控制</p>
      </div>
      <div className="bg-pure rounded-2xl shadow-card border border-progress/60 p-8 text-center">
        <div className="text-[14px] font-medium text-ink-2 mb-1">API Keys 管理</div>
