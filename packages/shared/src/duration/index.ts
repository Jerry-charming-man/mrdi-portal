...
export function diffDuration(a: Date, b: Date): string {
...
export const PERM_DURATION_LIMITS: Record<string, DurationLimits> = {
...
export function getDurationLimits(type: string): DurationLimits {
...
export function isWithinLimits(duration: string, type: string): boolean {
